          ...
          <Row className="w-100">
            <Col md={6} className="px-4 text-left">
              ...
              <p className="lead mb-4">
                Simplify your deployment process with DeployVault. Our platform
                offers seamless integration, powerful tools, and robust security
                to streamline your development workflow.
              </p>
              <p className="mb-5">
                Join thousands of developers who have already transformed their
                deployment experience. Start your journey with DeployVault today
          ...
          <Row className="w-100">
            ...
            <Col md={6} className="px-4 text-left">
              <p className="feature-description mb-4">
                DeployVault offers a comprehensive suite of tools designed to
                streamline your deployment workflow, enhance collaboration, and
                boost productivity.
              </p>
              <Row>
                <Col md={6} className="feature-box">
                  ...
                  <p>
                    Set up and manage complex deployment pipelines with ease,
                ...
                <Col md={6} className="feature-box">
                  ...
                  <p>
                    Benefit from industry-leading security measures to protect
                    your code and deployments at every step.
                  </p>
                </Col>
              </Row>
            </Col>
